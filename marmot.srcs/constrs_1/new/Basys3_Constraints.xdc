...
set_property PACKAGE_PIN T1 [get_ports sw_sel]
...
set_property PACKAGE_PIN T18 [get_ports Reset_and_Execute]
set_property IOSTANDARD LVCMOS33 [get_ports Reset_and_Execute]
#set_property PACKAGE_PIN W19 [get_ports btnL]
#set_property IOSTANDARD LVCMOS33 [get_ports btnL]
#set_property PACKAGE_PIN T17 [get_ports btnR]
#set_property IOSTANDARD LVCMOS33 [get_ports btnR]
set_property PACKAGE_PIN U17 [get_ports Reset_and_Load]
set_property IOSTANDARD LVCMOS33 [get_ports Reset_and_Load]



##Pmod Header JA
##Sch name = JA1
##set_property PACKAGE_PIN J1 [get_ports {Cout}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Cout}]
##Sch name = JA2
##set_property PACKAGE_PIN L2 [get_ports {Cin}]
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports M_clock]
set_property IOSTANDARD LVCMOS33 [get_ports M_clock]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets M_clock_IBUF]
...
#set_property PACKAGE_PIN W5 [get_ports M_clock]
#      set_property IOSTANDARD LVCMOS33 [get_ports M_clock]
...
create_clock -period 200.000 -name M_clock -waveform {0.000 100.000} [get_ports M_clock]
set_input_jitter M_clock 10.000
